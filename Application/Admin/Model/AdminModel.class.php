...
class AdminModel extends Model{
	protected $insertFields=array('username','password','cpassword','root_dir','bucket','chkcode');
	protected $updateFields=array('id','username','password','cpassword','root_dir','bucket');
	...
	public function login(){
		...
		if($user){
			...
			if($user['password']==md5($password)){
				...
				session('root_dir',$user['root_dir']);
				return TRUE;
			}else{
				$this->error="密码不正确！";
				return false;
