    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
          <!--  <form action="<?php echo U('Admin/User/insert');?>" method="post">
                试卷类型：&nbsp;&nbsp;&nbsp;<input type="text" name="zone_name" value="">
                <input type="submit" value="提交">
            </form>
            <hr>
            <form action="<?php echo U('Admin/User/insert');?>" method="post">
                地区：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="area" value=""><br>
                試卷的Id：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="area" value="">
                <input type="submit" value="提交">
            </form>
            <hr>
            <form action="<?php echo U('Admin/User/insert');?>" method="post">
                语文试题：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="yw_url1"><br>
                语文解析：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="yw_url2"><br>
                数学文试题：<input type="text" name="sx_url1"><br>
                数学文解析：<input type="text" name="sx_url2">
                <input type="submit" value="提交">
            </form>
            <hr>    
            <form action="<?php echo U('Admin/User/insert');?>" method="post">
                科目yw：<input type="text" name="yw"><br>
                科目sx：<input type="text" name="sx">
                <input type="submit" value="提交">
            </form>
            -->

            <form action="<?php echo U('Admin/User/insert');?>" method="post">
                <!-- 试卷类型：&nbsp;&nbsp;&nbsp;<input type="text" name="zone_name" value=""><br>
                科目yw：<input type="text" name="yw"><br>
                科目sx：<input type="text" name="sx"><br>
                地区：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="area" value=""><br>
                语文试题：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="yw_url1"><br>
                语文解析：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="yw_url2"><br>
                数学文试题：<input type="text" name="sx_url1"><br>
                数学文解析：<input type="text" name="sx_url2"> 
                <input type="submit" value="提交">-->
                试卷类型：&nbsp;&nbsp;&nbsp;<input class="zone_name" type="text" name="zone_name" value=""><br>
                地区：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="zone_area" type="text" name="zone_area" value=""><br>
                <input class="haha" type="submit" value="提交" onclick="return func()">  
            </form>
            <script>
                $(".haha").on("click",function(){
                    if($(".zone_name").val()==0 || $(".zone_name").val()==null){
                        alert("内卷类型不能为空");
                        return false;
                    }

                    if($(".zone_area").val()==0 || $(".zone_area").val()==null){
                        alert("地区不能为空");
                        return false;
                    }
