...
试题列表页
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
                <div style="width:100%;height:44px;display:block;">
                    <ul class="ul" style="list-style:none;">
                        <?php
 foreach($result as $kl => $vl) { ?>
                            <li class="li" style="float:left;">
                                <a class="aa" style="color:pink;" href="<?php echo $vl['title_Url']; ?>"><?php echo $vl['content_Title']; ?></a>
                                <a class="bj" href="<?php echo U('Admin/User/edit',array('id'=>$vl['id']));?>">编辑</a>
                               | <a class="sc" href="<?php echo U('Admin/User/del',array('id'=>$vl['id']));?>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </li>
                        <?php
 } ?>
                    </ul>
                </div>
                <?php if(is_array($res)): foreach($res as $k=>$vo): ?><div style="width:100%;height:3px;background-color:#ccc;"></div>
                <div><div style="float:left;color:blue;font-size:18px;font-weight:bold;"><?php echo $vo['zone_name']; ?></div><div style="float:left;margin-left:140px;" class="diqu"><?php echo ($vo['zone_area']); ?></div>  <a class="bianji" href=""> 编辑</a> | <a class="del" href="<?php echo U('Admin/User/dele',array('zone_id'=>$vo['zone_id']));?>"> 删除</a></div>
                <hr>
                 
                <?php
 foreach($vo['son'] as $k=>$val){ ?>
                <div class="cor" style="color:orange;background-color:#F7F7F7;font-weight:bold;"><?php echo $val['subject']; ?><p><a href="<?php echo $val['url1']; ?>">试题</a> | <a href="<?php echo $val[url2]; ?>">解析</a> | <a class="now" href="<?php echo U('Admin/User/delete',array('id'=>$val['id']));?>" target="_blank">删除</a> | <a class="" href="">编辑</a></p></div>
