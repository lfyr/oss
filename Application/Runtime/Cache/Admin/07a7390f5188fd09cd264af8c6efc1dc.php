...
<link href="/renshi/Public/Css/mypage.css" rel="stylesheet" type="text/css"/>
    ...
    <div style="position:absolute;float:left;">在职员工列表</div>
        ...
        <a class="download" href="<?php echo U('Admin/User/download');?>" style="width:100px;height:30px;float:left;font-size:12px;margin-top:2px;">在职下载</a>
        <div class="has-feedback" style="float:left;">
            <form action="/renshi/index.php/Admin/User/lists" method="GET">
                            ...
                            <form action="/renshi/index.php/Admin/User/lists" method="get">
                                <tr>
                                    ...
                                    <th class="font-text xiaoqu">校区 
                                        <select name="stCampus" id="stCampus" style="width:51px;" onChange="GaiBian(this)">
                                        <script type="text/javascript">
                                            function GaiBian(){
                                                //获得下拉框元素的值
                                                var stCampus = $("#stCampus").val();
                                                var info = 'name='+stCampus;
                                                ...
                                                xhr.open('post',(U('Admin/user/lists')));
