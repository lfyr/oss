...
试题列表頁
 ...
 foreach($result as $kl => $vl) { ?>
                            <li class="li" style="float:left;">
                                ...
                                <a class="bj" href="<?php echo U('Admin/User/edit',array('id'=>$vl['id']));?>">編輯</a>
                                <a class="sc" href="<?php echo U('Admin/User/del',array('id'=>$vl['id']));?>">刪除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </li>
                ...
                <div><div style="float:left;color:blue;font-size:18px;font-weight:bold;"><?php echo $vo['zone_name']; ?></div><div style="float:left;margin-left:140px;" class="diqu"><?php echo ($vo['zone_area']); ?></div>  <a class="bianji" href="">编辑</a> | <a class="del" href="">删除</a></div>
                <hr>
                 
                <?php
 foreach($vo['son'] as $k=>$val){ ?>
                <div class="cor"><?php echo $val['subject']; ?><p><a href="<?php echo $val['url1']; ?>">試題</a> | <a href="<?php echo $val[url2]; ?>">解析</a> | <a class="now" href="<?php echo U('Admin/User/delete',array('id'=>$val['id']));?>" target="_blank">删除</a> | <a class="" href="">编辑</a></p></div>
