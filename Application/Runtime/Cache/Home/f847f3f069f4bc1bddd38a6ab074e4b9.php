...
<link rel="stylesheet" href="/Public/Home/css/index.css?t=<?php echo time();?>" />
<script src="/Public/Home/js/jquery-1.8.3.min.js" type="text/javascript" charset="utf-8"></script>
<script src="_/Public/Home/js/index.js" type="text/javascript" charset="utf-8"></script>
...
<div class="doc">
 ...
 foreach($result as $kl=>$vl){ ?>
			<a class="linkA_1" href="<?php echo $vl['title_Url']; ?>" target="_blank"><?php echo $vl['content_Title']; ?></a>
			<?php
 } ?>
			<!--<a class="linkA_2" href="http://s.dearedu.com/list.php?Keyword=2016年普通高等学校招生全国统一考试+解析" target="_blank">2017试题解析</a>
			<a class="linkA_3" href="http://s.dearedu.com/list.php?g=1&amp;t=18&amp;ye=2016" target="_blank">2017真题书稿</a>
			<a class="linkA_4" href="javascript:void();" target="_blank">2017英语听力</a> <a class="linkA_5" href="http://www.dearedu.com/zt/ljzt/" target="_blank">历届高考试题</a>-->
		</div>
		<div class="navB">
