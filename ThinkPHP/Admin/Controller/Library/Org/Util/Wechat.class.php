...
class Wechat
{
	...
	public function getRev()
	{
		...
		if (!empty($postStr)) {
			...
			$this->_receive = simplexml_load_string($postStr);
		}
		return $this;
	}
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	public function getOauthUserinfo($access_token,$openid){
		...
		// echo self::API_BASE_URL_PREFIX.self::OAUTH_USERINFO_URL.'access_token='.$access_token.'&openid='.$openid;
		// var_dump($result);
		if ($result)
		{
			$json = json_decode($result,true);
